...
<head>
    ...
    <title>Kategooriad | Riksi Blogi</title>
...
<body class="bg-base-200">
    ...
    <div class="animated-gradient text-white py-24">
        <div class="container mx-auto px-4 text-center">
            <div class="badge badge-lg bg-white/20 text-white border-none mb-4">📂 Kategooriad</div>
            <h1 class="text-5xl md:text-6xl font-bold mb-4">Avasta teemad</h1>
            <p class="text-xl opacity-90">Vali kategooria ja hakka lugema</p>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($categories as $category)
                <a href="/kategooria/{{ $category->slug }}" class="category-card card bg-base-100 shadow-xl hover:shadow-2xl">
                    <div class="card-body text-center">
                        ...
                        <h2 class="card-title text-2xl justify-center">{{ $category->name }}</h2>
                        <p class="text-base-content/60">{{ $category->posts_count }} postitust</p>
                        <div class="card-actions justify-center mt-4">
                            <div class="btn btn-primary btn-sm">Vaata postitusi →</div>
                        </div>
                    </div>
                </a>
            @endforeach
